...
class _CovidHospitalState extends State<CovidHospital> {
  ...
  Future<void> getHospitals() async {
    ...
    if (_permissionGranted == PermissionStatus.denied) {
      ...
      if (_permissionGranted != PermissionStatus.granted) {
        widgetPlaceholder = Center(
          child: Container(padding: EdgeInsets.all(10), color: Colors.white, child: Text("Please turn on your gps")),
        );
        setState(() {
          _isLoading = false;
        });
    ...
    if (placemarks[0].country == "Indonesia" && provinceCode != "" && cityCode != "") {
      var rsBed = await http.get(Uri.parse("https://rs-bed-covid-api.vercel.app/api/get-hospitals?provinceid=$provinceCode&cityid=$cityCode&type=1"));
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: (hospitals[index]['bed_availability'] == 0) ? Color(0xFFa11616) : Colors.transparent,
                        width: 5,
                      ),
                    ),
                    child: Column(
                      children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Column(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [
                                      (hospitals[index]['bed_availability'] == 0)
                                          ? Container(
                                          ...
                                          : Container(
                                              child: Column(
                                                children: [
                                                  ...
                                                  Text(
                                                    (hospitals[index]['queue'] == 0) ? "Tanpa antrean" : "Antrean: ${hospitals[index]['queue']}",
                                                  ),
                                                ],
                                              ),
                                            ),
                        ...
                        Row(
                          ...
                          children: [
                            GestureDetector(
                              onTap: () {
                                _launchURL('tel:://${hospitals[index]['phone']}');
                              },
                            ...
                            Wrap(
                              children: [
                                  ...
                                  child: OutlinedButton(
                                    onPressed: () async {
                                      var responseDetail = await http.get(
                                          Uri.parse("https://rs-bed-covid-api.vercel.app/api/get-hospital-map?hospitalid=${hospitals[index]['id']}"));
                                      var detailData = json.decode(responseDetail.body)['data'];
                                      _launchURL('https://www.google.com/maps/search/?api=1&query=${detailData['lat']},${detailData['long']}');
                                    },
                                    style: ButtonStyle(
                                      foregroundColor: MaterialStateProperty.all(Color(0xFF004469)),
                                ...
                                Container(
                                  ...
                                  child: OutlinedButton(
                                    onPressed: () {
                                      Navigator.push(context, MaterialPageRoute(builder: (context) => HospitalDetail(id: hospitals[index]["id"])));
                                    },
                                    style: ButtonStyle(
                                      foregroundColor: MaterialStateProperty.all(Color(0xFF004469)),
                                      shape: MaterialStateProperty.all(
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: RefreshIndicator(
          ...
          child: (_isLoading) ? LoadingWidget(callbackFunc: getHospitals) : widgetPlaceholder,
        ),
      ),
    );
  }
